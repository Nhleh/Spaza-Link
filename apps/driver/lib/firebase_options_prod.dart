// Firebase options for the PROD environment — driver app.
...
class DefaultFirebaseOptions {
  ...
  static const FirebaseOptions ios     = FirebaseOptions(apiKey: 'PROD_IOS_API_KEY',     appId: 'PROD_IOS_APP_ID',     messagingSenderId: 'PROD_SENDER_ID', projectId: 'spazalink-prod', storageBucket: 'spazalink-prod.firebasestorage.app', iosBundleId: 'com.spazalink.driver');
}
