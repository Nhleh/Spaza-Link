// Firebase options for the STAGING environment — driver app.
...
class DefaultFirebaseOptions {
  ...
  static const FirebaseOptions ios     = FirebaseOptions(apiKey: 'STAGING_IOS_API_KEY',     appId: 'STAGING_IOS_APP_ID',     messagingSenderId: 'STAGING_SENDER_ID', projectId: 'spazalink-staging', storageBucket: 'spazalink-staging.firebasestorage.app', iosBundleId: 'com.spazalink.driver.staging');
}
