...
class FirebaseProductRepository implements ProductRepository {
  ...
  Stream<List<ProductModel>> watchProducts({
    ...
    Query<Map<String, dynamic>> q = _col.where('isAvailable', isEqualTo: true);
  ...
  Future<List<ProductModel>> searchProducts(String query) async {
    // Fetch available products and filter client-side.
    // TODO: replace with Algolia/Typesense in Phase 8.
    final snap = await _col.where('isAvailable', isEqualTo: true).get();
